...
class CustomizedGradesController {
    ...
    async create(request: Request, response: Response): Promise<Response> {
        ...
        try {
            const customizedGrade = await singletonCustomizedGrades.getInstance().create(Number(idUnit), description, Number(numericValue));
    ...
    async updateById(request: Request, response: Response): Promise<Response> {
        ...
        try {
            const customizedGrade = await singletonCustomizedGrades.getInstance().updateById(Number(id), Number(idUnit), description, Number(numericValue));
    ...
    async deleteById(request: Request, response: Response): Promise<Response> {
        try {
            ...
            const customizedGrade = await singletonCustomizedGrades.getInstance().deleteById(Number(id));
